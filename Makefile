...
MLMODULES = weakke ddcustom $(IDLMODULES) mapleaf mtbdd
...
essai.byte: essai.ml cudd.cma libcudd_caml_debug.a
	...
	-ccopt -L$(CUDD_INSTALL)/lib -cclib "-lcudd_debug -lmtr -lst -lutil -lepd" \
	-ccopt -L$(CAML_INSTALL)/lib/ocaml -cclib "-lcamlrun_debug"
essai.opt: essai.ml cudd.cmxa libcudd_caml_debug.a
...
cuddaux%.c: cuddaux.h cuddauxInt.h

%_caml.c: cudd_caml.h cuddaux.h cuddauxInt.h

bdd.cmo: man.cmi bdd.cmi
bdd.cmx: man.cmx bdd.cmi
ddcustom.cmo: man.cmi bdd.cmi ddcustom.cmi
ddcustom.cmx: man.cmx bdd.cmx ddcustom.cmi
...
mtbdd.cmo: weakke.cmi vdd.cmi mapleaf.cmi ddcustom.cmi mtbdd.cmi
mtbdd.cmx: weakke.cmx vdd.cmx mapleaf.cmx ddcustom.cmx mtbdd.cmi
rdd.cmo: man.cmi ddcustom.cmi bdd.cmi rdd.cmi
rdd.cmx: man.cmx ddcustom.cmx bdd.cmx rdd.cmi
session.cmo: vdd.cmi rdd.cmi manager.cmi bdd.cmi
session.cmx: vdd.cmx rdd.cmx manager.cmx bdd.cmx
t.cmo: weakke.cmi
t.cmx: weakke.cmx
vdd.cmo: rdd.cmi man.cmi ddcustom.cmi bdd.cmi vdd.cmi
vdd.cmx: rdd.cmx man.cmx ddcustom.cmx bdd.cmx vdd.cmi
weakke.cmo: weakke.cmi
weakke.cmx: weakke.cmi
bdd.cmi: man.cmi
ddcustom.cmi: man.cmi bdd.cmi
manager.cmi:
man.cmi:
mapleaf.cmi: vdd.cmi man.cmi bdd.cmi
mtbdd.cmi: weakke.cmi vdd.cmi man.cmi ddcustom.cmi bdd.cmi
rdd.cmi: man.cmi ddcustom.cmi bdd.cmi
vdd.cmi: man.cmi ddcustom.cmi bdd.cmi
weakke.cmi:
